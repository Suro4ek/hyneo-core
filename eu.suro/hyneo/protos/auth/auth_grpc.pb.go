...
func (c *authClient) UnRegister(ctx context.Context, in *UnRegisterRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedAuthServer) UnRegister(context.Context, *UnRegisterRequest) (*Empty, error) {
